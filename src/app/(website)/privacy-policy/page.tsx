...
function page() {
  return (
    <div className="text-lg w-[90%] md:w-[70%] mx-auto">
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to Appointify.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to Appointify, accessible from{" "}
            <a
      ...
      <ul>
        <li>By email: chambharem1@gmail.com</li>
      </ul>
    </div>
  );
}
