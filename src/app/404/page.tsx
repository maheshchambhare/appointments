...
function Custom404() {
  return (
    <main className="flex bg-background flex-col w-[100vw] min-h-[100vh] p-0 m-0 ">
      <div className="w-full h-screen flex flex-col lg:flex-row items-center justify-center space-y-16 lg:space-y-0 space-x-8 2xl:space-x-0">
        <div className="w-full mt-10 lg:w-1/2 flex flex-col items-center justify-center lg:px-2 xl:px-0 text-center">
        ...
        <div className="w-full md:w-1/2 lg:h-full flex lg:items-end justify-center p-4">
          <svg
